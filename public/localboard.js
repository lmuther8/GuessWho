...
function displayhiddenChar(hiddenChar) {
  document.getElementById('hiddenChar').innerHTML='<div class="purple"><h5 class="center">Mystery Character</h5><div class="center" id="'+hiddenChar[0]+' '+hiddenChar[1]+'"><h5>'+hiddenChar[0]+' '+hiddenChar[1]+'</h5><div><a><img src="'+hiddenChar[2]+'" style="width: 70%;"></a></div></div></div>';
}
